...
private void removeProduct() {
    int selectedRow = productTable.getSelectedRow(); // Obtener fila seleccionada en la tabla
    String productName = null;

    if (selectedRow != -1) {
        // Obtener el nombre del producto de la fila seleccionada
        productName = (String) productTableModel.getValueAt(selectedRow, 0);
    } else {
        // Si no hay una selección en la tabla, solicitar el nombre del producto
        productName = JOptionPane.showInputDialog(this, "Ingrese el nombre del producto a eliminar:");
    }
